...
<html>
  ...
  <body>
    ...
    <?php
        ...
        #Creamos una clase anonima con argumentos y que hereda de Persona
        use Clases\persona\Persona as apodoPersona;
        (new class(10) extends apodoPersona{
          private $numero;
          public function __construct($num)
          {
            #parent:: = para utilizar metodos de la clase padre
            parent::ObtenerEdad(1999);
          }
        });
    ?>
  </body>
